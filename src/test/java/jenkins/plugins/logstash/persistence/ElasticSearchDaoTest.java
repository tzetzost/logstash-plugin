...
public class ElasticSearchDaoTest {
  ...
  ElasticSearchDao createDao(String host, int port, String key, String username, String password, String proxyHost, int proxyPort) {
    return new ElasticSearchDao(mockClientBuilder, host, port, key, username, password, proxyHost, proxyPort);
  }

  @Before
  public void before() throws Exception {
    int port = (int) (Math.random() * 1000);
    dao = createDao("http://localhost", port, "/jenkins/logstash", "username", "password", "", -1);
  ...
  public void constructorFailNullHost() throws Exception {
    try {
      createDao(null, 8200, "logstash", "username", "password", "", -1);
  ...
  public void constructorFailEmptyHost() throws Exception {
    try {
      createDao(" ", 8200, "logstash", "username", "password", "", -1);
    } catch (IllegalArgumentException e) {
      assertEquals("Wrong error message was thrown", "host name is required", e.getMessage());
      throw e;
    }
  ...
  public void constructorFailMissingScheme() throws Exception {
    try {
      createDao("localhost", 8200, "logstash", "username", "password", "", -1);
    } catch (IllegalArgumentException e) {
  ...
  public void constructorFailNullKey() throws Exception {
    try {
      createDao("http://localhost", 8200, null, "username", "password", "", -1);
    } catch (IllegalArgumentException e) {
  ...
  public void constructorFailEmptyKey() throws Exception {
    try {
      createDao("http://localhost", 8200, " ", "username", "password", "", -1);
    } catch (IllegalArgumentException e) {
      assertEquals("Wrong error message was thrown", "elastic index name is required", e.getMessage());
      throw e;
    }
  ...
  public void constructorSuccess1() throws Exception {
    // Unit under test
    dao = createDao("https://localhost", 8200, "logstash", "username", "password", "", -1);
  ...
  public void constructorSuccess2() throws Exception {
    // Unit under test
    dao = createDao("http://localhost", 8200, "jenkins/logstash", "", "password", "", -1);
  ...
  public void constructorSuccess3() throws Exception {
    // Unit under test
    dao = createDao("http://localhost", 8200, "/jenkins//logstash/", "userlongername", null, "", -1);
  ...
  public void getPostSuccessNoAuth() throws Exception {
    String json = "{ 'foo': 'bar' }";
    dao = createDao("http://localhost", 8200, "/jenkins/logstash", "", "", "", -1);
  ...
  public void getPostSuccessAuth() throws Exception {
    String json = "{ 'foo': 'bar' }";
    dao = createDao("https://localhost", 8200, "/jenkins/logstash", "username", "password", "", -1);
  ...
  public void pushFailStatusCode() throws Exception {
    String json = "{ 'foo': 'bar' }";
    dao = createDao("http://localhost", 8200, "/jenkins/logstash", "username", "password", "", -1);
